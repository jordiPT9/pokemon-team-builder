...
class TeamBuilder:
  ...
  def print_best_teams(self):
    ...
    print("Best Teams:")
    print("")
    for i, team in enumerate(self.best_teams, start=1):
      print(f"Team {i}:")
      base_totals = 0
      total_weaknesses = 0
      for pokemon in team:
      ...
      print(f"Weaknesses: {self.best_overall_weaknesses_score}")
      print(f"Resistances: {self.best_overall_resistances_score}")
      print("")
